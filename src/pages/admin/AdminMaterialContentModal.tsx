          ...
          <div className="space-y-6 overflow-y-auto px-6 py-5">
            ...
            <section>
              ...
              <input
                ...
                onBlur={saveName}
                className={[
                  'w-full rounded-lg border px-3 py-2 text-[17px] sm:text-sm focus:outline-none',
                  nameError
            ...
            <section>
              ...
              <select
                ...
                className="w-full rounded-lg border border-gray-300 px-3 py-2 text-[17px] sm:text-sm focus:border-[var(--c-brand)] focus:bg-[var(--c-brand-50)] focus:outline-none"
              >

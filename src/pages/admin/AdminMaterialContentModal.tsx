          ...
          <div className="space-y-6 overflow-y-auto px-6 py-5">
            ...
            <section>
              ...
              <input
                ...
                onBlur={saveName}
                className={[
                  'w-full rounded-lg border px-3 py-2 text-[17px] sm:text-sm focus:outline-none focus:ring-1',
                  nameError
                    ...
                    >
                      ...
                      <div className="min-w-0 space-y-2">
                        <input
                          ...
                          className="w-full rounded border border-gray-300 px-2 py-1 text-[17px] sm:text-sm focus:border-gray-900 focus:outline-none focus:ring-1 focus:ring-gray-900"
                        />
                        <input
                          type="text"
                          value={feature.body}

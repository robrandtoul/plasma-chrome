      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mt-4">
          ...
          <input
            ...
            className="mt-1 w-full rounded border border-gray-300 px-3 py-2 text-[17px] sm:text-sm focus:border-[var(--c-brand)] focus:bg-[var(--c-brand-50)] focus:outline-none"

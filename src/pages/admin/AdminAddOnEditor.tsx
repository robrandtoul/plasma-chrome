      ...
      <tr className="border-t border-gray-100 bg-gray-50/40">
        <td className="px-4 py-2">
          <select
            ...
            disabled={saving}
            className="rounded-md border border-gray-200 px-2 py-1 text-[17px] sm:text-sm tabular-nums focus:border-[var(--c-brand)] focus:bg-[var(--c-brand-50)] focus:outline-none"
          >
            ...
            <td key={c} className="px-4 py-2">
              <div className="relative inline-block">
                ...
                <input
                  ...
                  disabled={saving}
                  className="w-24 rounded-md border border-gray-200 px-2 py-1 pl-5 text-[17px] sm:text-sm tabular-nums focus:border-[var(--c-brand)] focus:bg-[var(--c-brand-50)] focus:outline-none"
                />
              </div>
            </td>
          )
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mt-4">
          ...
          <input
            ...
            className="mt-1 w-full rounded-md border border-gray-300 px-3 py-2 text-[17px] sm:text-sm focus:border-[var(--c-brand)] focus:bg-[var(--c-brand-50)] focus:outline-none"

...
//
// Twin of supabase/functions/_shared/ukVatArea.ts (Vite and Deno can't
// share a module cleanly — if you change one, change the other).
// ukVatArea.test.ts imports BOTH copies and fails on any drift.

...
// asked to confirm.
//
// Twin of src/lib/shipDestCheck.ts (Vite and Deno can't share a module
...
import { normaliseShipDestination } from './ukVatArea.ts'
import { isNorthernIrelandPostcode } from './shipping.ts'

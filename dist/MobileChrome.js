...
export function MobileChrome(props) {
    ...
    return (_jsxs("div", { className: "pd-chrome-mobile", children: [_jsxs("div", { className: "pd-chrome__mobile-bar", children: [appsVisible || apps.length < 2 ? (_jsxs(_Fragment, { children: [_jsx("span", { className: "pd-chrome__app-mark", style: { width: 28, height: 28, borderRadius: 8 }, children: appGlyph(currentApp, 16, appName) }), _jsx("span", { className: "pd-chrome__mobile-title", children: appName })] })) : (_jsxs("button", { type: "button", onClick: openAccount, "aria-haspopup": "dialog", "aria-expanded": sheet === 'account', style: {
                            display: 'flex',
                            alignItems: 'center',
                            gap: 10,
                            minWidth: 0,

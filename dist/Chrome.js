...
export function Chrome(props) {
    const { apps, currentApp, nav, activeNavId, mobileTabIds, mobileTabs, accountLinks, user, linkComponent, search, actions, chat, chatUnread, chatMentionUnread, notificationsUnread, appsVisible: controlledAppsVisible, onAppsVisibleChange, onSignOut, onEditProfile, variant = 'full', } = props;
